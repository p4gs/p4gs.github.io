 ...
 * INSTALLS Scorecard and ships it as one of its own 54 controls. Both are
...
export function compareSection(h: Href): string {
  ...
  return `<section class="method-section prose cmp-section" id="${COMPARE_SECTION_ID}">
    <h2>${COMPARE_TITLE}</h2>
    <p>These are not rival tools. sscsb <strong>installs</strong> Scorecard: one of its 54
